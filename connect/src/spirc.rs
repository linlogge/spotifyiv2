...
impl SpircTask {
    ...
    fn handle_play(&mut self) {
        ...
        // systems that can switch sources from and back to spotifyiv2.
    ...
    fn handle_next(&mut self) {
        ...
        if new_index >= tracks_len {
            ...
            // in such cases there is no context in spotifyiv2.
    ...
    fn get_track_id_to_play_from_playlist(&self, index: u32) -> Option<(SpotifyId, u32)> {
        ...
        // https://github.com/spotifyiv2-org/spotifyiv2/issues/226#issuecomment-971642037
        if tracks_len == 0 {
