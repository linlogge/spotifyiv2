...
//! Those can be used to establish a new Session with [`spotifyiv2_core`].
//!
...
use spotifyiv2_core as core;

/// Credentials to be used in [`spotifyiv2`](`spotifyiv2_core`).
...
impl Builder {
    ...
    /// Sets the name to be displayed. Default is `"spotifyiv2"`.
